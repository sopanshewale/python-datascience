...
def captch_ex(file_name):
    ...
    img2gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY, 0)
    ...
    #(contours, hierarchy, _) = cv2.findContours(dilated, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)  # get contours
